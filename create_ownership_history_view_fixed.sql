...
-- Create a comprehensive ownership history view using the EXISTING matches table
...
COMMENT ON VIEW v_ownership_history IS 'Comprehensive ownership history view using the existing land_registry_ch_matches table';
